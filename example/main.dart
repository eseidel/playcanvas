...
void main() {
  ...
  // final app = pc.Application(canvas, newObject());

  // // create box entity
  // final box = pc.Entity("cube");
  // box.addComponent(
  //   "render",
  //   jsify({
  //     'type': "box",
  ...
  // final camera = pc.Entity("camera");
  // camera.addComponent("camera", jsify({'clearColor': pc.Color(0.5, 0.6, 0.9)}));

  // app.root.addChild(camera);
  // camera.setPosition(0, 0, 3);

  // // create directional light entity
  // final light = pc.Entity("light");
